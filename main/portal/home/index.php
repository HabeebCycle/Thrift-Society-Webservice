    ...
    <div class="container body">
	  ...
	  <div class="x_panel col-sm-10">
		<div class="x_title" style="font-family:Andalus;color:purple">
		  <h3 align="center">Welcome to Accounting Management System</h3><h2 align="center"><?php echo $_SESSION['uname'].' ('.$_SESSION['name'].') - '.$tr1['name']; ?></h2><br/>
					...
					<a href="home" style="font-size:18px; color:a0a;" >
						<div class="animated flipInY col-lg-6 col-md-6 col-sm-6 col-xs-12">
							<div class="tile-stats alert-default">
							  <div class="" style="font-size:30px;text-align:center;"><i class="fa fa-tachometer "></i><br/>Dashboard </div>
							</div>
						</div>
					</a><!--
